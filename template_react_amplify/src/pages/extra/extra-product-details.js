...
function ExtraProductDetails() {
  ...
  const handleAdditionTagsSize = useCallback((newTag) => {
  ...
  const handleAdditionTagsMaterial = useCallback((newTag) => {
  ...
  const handleAdditionTagsColor = useCallback((newTag) => {
  ...
  const handleAdditionTagsAll = useCallback((newTag) => {
					...
					<div className="card border-0 mb-4">
						...
						<div className="card-body">
							...
							<div className="row mb-3 gx-3">
								...
								<div className="col-7">
									<ReactTags tags={tagsSize} allowNew={true}  onDelete={handleDeleteTagsSize.bind(this)} onAddition={handleAdditionTagsSize} />
								</div>
								<div className="col-1">
							...
							<div className="row mb-3 gx-3">
								...
								<div className="col-7">
									<ReactTags tags={tagsColor} allowNew={true}  onDelete={handleDeleteTagsColor.bind(this)} onAddition={handleAdditionTagsColor.bind(this)} />
								</div>
								<div className="col-1">
									<a href="#/" className="btn btn-default d-block"><i className="fa fa-trash"></i></a>
								</div>
							...
							<div className="row mb-3 gx-3">
								...
								<div className="col-7">
									<ReactTags tags={tagsMaterial} allowNew={true} onDelete={handleDeleteTagsMaterial.bind(this)} onAddition={handleAdditionTagsMaterial.bind(this)} />
								</div>
								<div className="col-1">
									<a href="#/" className="btn btn-default d-block"><i className="fa fa-trash"></i></a>
								</div>
				...
				<div className="col-xl-4">
					...
					<div className="card border-0 mb-4">
						...
						<div className="card-body">
							...
							<ReactTags tags={tagsAll} allowNew={true} onDelete={handleDeleteTagsAll} onAddition={handleAdditionTagsAll} />
						</div>
					</div>
				</div>
			</div>
