...
//NEW ROUTES
import CreateOrganization from './../pages/organizations/CreateOrganization.js';
import ListOrganizations from '../pages/organizations/ListOrganizations.js';
			...
			},
    	{
			...
			},
			{
				...
				children: [
					...
					{ path: 'list', element: <ListOrganizations /> }
