const Menu = [
  ...
  { path: 'organizations', icon: 'fa fa-sitemap', title: 'Organizations',
    children: [
      { path: 'organizations/create', title: 'Create Organization' },
      { path: 'organizations/list', title: 'List Organizations' },
