...
export default function AddOrganization(props) {
  ...
  const resetStateValues = () => {
    setAssignedDevices(initialValues.assignedDevices);
    setTotalDevices(initialValues.totalDevices);
    setUsers(initialValues.users);
    setCell(initialValues.cell);
    setAuthcode(initialValues.authcode);
    setName(initialValues.name);
    setEmail(initialValues.email);
    setBillingAddresstimezone(initialValues.billingAddresstimezone);
    setBillingAddressaddress(initialValues.billingAddressaddress);
    setBillingAddresscountry(initialValues.billingAddresscountry);
    setBillingAddressstate(initialValues.billingAddressstate);
    setBillingAddresspostalCode(initialValues.billingAddresspostalCode);
    setBillingAddresscity(initialValues.billingAddresscity);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "AddOrganization")}
      {...rest}
    >
      <TextField
